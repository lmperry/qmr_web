...
function getSideBar($page_input) {
    ...
    if(strcasecmp($page_input,"dti") == 0) {
        $current_dti = "current";
    }
    ...
    // If this is the main index page, show the side bar for it
    if (strcasecmp($page_input, 'labindex') == 0)
    {
        ?>
        <hr>
        <br>
      ...
      { ?>
        ...
        <h2>View Results</h2>
            ...
            <?php
                ...
                if(is_dir($figures_dir . "/" .  $mrqdir)) {
                    echo "<li class=\"$current_mrq\"><a href=\"mrq.php\">MRQ Maps</a></li>";
                }
               if(is_dir($figures_dir . "/" . $sessions[1] . "/" . $t1dir)) {
                    echo "<li class=\"$current_t1\"><a href=\"t1.php\">Quantitative T1</a></li>";
                }
                if(is_dir($figures_dir . "/" . $sessions[1] . "/" . $tvdir)) {
                    echo "<li class=\"$current_tv\"><a href=\"tv.php\">Quantitative TV</a></li>";
                }
                if(is_dir($figures_dir . "/" . $sessions[1] . "/" . $sidir)) {
                    echo "<li class=\"$current_si\"><a href=\"si.php\">Quantitative SIR</a></li>";
                }
               if(is_dir($figures_dir . "/" . $sessions[1] . "/" . strtolower($dtidir))) {
                    echo "<li class=\"$current_dti\"><a href=\"dti.php\">DTI Maps</a></li>";
                }
